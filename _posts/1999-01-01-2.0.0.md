...
přidána možnost počítat <abbr title="Strategický plán">SP</abbr> pro více období. Období je možné navolit podobně jako v <abbr title="Reachové křivky">RC</abbr> s tím rozdílem, že u každého daypartu je pak možné navolit období zvlášť. Ve Výstupu přibyl odpovídající sloupec, který zobrazuje období vybrané na Zadání. Z výstupu <abbr title="Strategický plán">SP</abbr>, kde je použito více období, nelze vytvářet <abbr title="Reachové křivky">RC</abbr> a <abbr title="Detailní plán">DP</abbr>
