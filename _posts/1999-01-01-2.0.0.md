...
## <abbr title="Strategický plán">SP</abbr>, <abbr title="Crossmediální postanalýza">CMPA</abbr> - výpočet s rozhlasovými a rádiovými sítěmi
V <abbr title="Strategický plán">SP</abbr> lze nově počítat s rozhlasovými sítěmi a v <abbr title="Crossmediální postanalýza">CMPA</abbr> s rádiovými sitěmi.
...
V <abbr title="Crossmediální postanalýza">CMPA</abbr> Nastavení výpočtu přibyla možnost počítat TV pouze inhome.
