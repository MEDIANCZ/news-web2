...
Do záložky Seskupení dle ukazatelů bylo přidáno okno Ukazatele, které funguje stejně jako na výstupu a nově lze definovat počet histogramů a frekvencí k zobrazení, počet destinných míst a zapnutí výpočtu ukazatele pro všechny cílové skupiny.
