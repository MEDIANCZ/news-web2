...
## <abbr title="Reachové křivky">RK</abbr> - Vytvoření křivek pro ostatní období a cílové skupiny
...
## <abbr title="Detailní plán">DP</abbr> - Dokoupené (Floating) pro "Ostatní stanice"
...
## Editor <abbr title="Nákupní podmínky">NP</abbr> - změna ikony pro přidání a odebrání uživatelských NP
Pro zlepšení intuitivnosti byla změněna ikona tužky na ikonu plus, pro přidání uživatelských NP pro vybrané médium. Pokud jsou uživatelské NP pro vybrané médium definovány, byla změněna na ikonu koše pro odebrání uživatelských NP.
...
<ul>
	...
	<li><abbr title="Reachové křivky">RK</abbr> - doplnění tooltipů pro záhlaví sloupců tabulky (např. období, cílová skupina atp.)</li>
