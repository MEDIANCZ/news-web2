...
V reachových křivkách a strategickém plánu na Admeter datech lze nově používat externí datové zdroje. Po vyplnění příslušných přístupových tokenů v nastavení Cloudu se v Editoru definic částí dnů zpřístupní nový sloupec Zdroj dat. 
Pro facebook.com, instagram.com a messenger.com umožňujeme výpočet nad daty Facebooku a pro youtube.com využití datového zdroje firmy Google. Dále je možné počítat většinu televizních kanálů nad PEM daty.   
Externí datové zdroje mají jistá omezení daná poskytovateli dat. Především omezení cílových skupin a možnost plánovat pouze do budoucnosti (s výjímkou PEM). 
...
V Editoru definic částí dnů lze nově u mediatypu Internet a webpacků navolit zdali se mají data načítat pouze z desktopových zásahů, mobilních, nebo kombinace obojího.
